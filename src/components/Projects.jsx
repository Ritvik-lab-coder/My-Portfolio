            ...
            <div>
                <div className='mb-8 flex flex-wrap lg:justify-center'>
                    ...
                    <motion.div whileInView={{ opacity: 1, x: 0 }} initial={{ opacity: 0, x: 100 }} transition={{ duration: 1.5 }} className='w-full max-w-xl lg:w-3/4'>
                        <h6 className='mb-2 font-semibold'>Farm Fresh Products E-Commerce Platform - <a href="https://agri-boost-frontend.vercel.app/" target="_blank" rel="noopener noreferrer">AgriBoost</a></h6>
